...
export const QUEST_CATALOG = [
  ...
  {
    id: 'changeSim',
    questTitle:  '【通信の呪縛】格安SIMの魔法陣へ換装せよ！',
...

  {
    ...
    description: '日本には「高額療養費」や「傷病手当金」という強力な公的バリアが最初から備わっている！'
               ...
               + '（※公的保障は医療費や収入低下を補うものだが、'
               + '差額ベッド代・食事療養費・先進医療の技術料は対象外だ）',
  ...
  {
    id: 'consolidateCard',
    questTitle:  '【リボ払いの呪縛】高還元カードへ錬金せよ！',
...
export const SCOUT_QUEST_TEXT = {
  smartphone: {
    id:'scoutSmartphone',
    mainTitle:'【通信費の索敵】マイページに潜み、正体を暴け！',
...
// ---------------------------------------------------------------------------
// 錬金術クエスト（ふるさと納税・iDeCo）の文言
//   ★指定文言をそのまま使用する（独自解釈をしない）。節税効果は年収・税率により個人差が
//     大きく法令数値として断定できないため、節約額（monthlySaving）は判定対象としない
//     （CLAUDE.md 制約7：推測で埋めない）。
// ---------------------------------------------------------------------------
export const ALCHEMY_QUEST_TEXT = {
  furusato: {
    id:'alchemyFurusato',
    mainTitle:'【錬金術】国境の村へ支援（ふるさと納税）し、返礼品の装備を獲得せよ！',
    detail:'実質2,000円の負担で地方の特産品（肉や米などの食料アイテム）を獲得できる強力な錬金術だ！専用サイトで自分の年収からの上限額をシミュレーションせよ！'
  },
  ideco: {
    id:'alchemyIdeco',
    mainTitle:'【時の封印】iDeCo（確定拠出年金）で強力な節税バリアを展開せよ！',
    detail:'原則60歳まで引き出せない「時の封印」の代償として、掛け金が全額所得控除になる最強の節税魔法だ！老後資金の育成として検討せよ！'
  }
};
...
export const NEW_FIXED_QUESTS = {
  internet: {
    id: 'reviewInternet',
    mainTitle: '【回線の魔道結界】格安光回線やセット割へ乗り換えよ！',
    subTitle: '光回線の月額料金を見直す',
    detail: '毎月なんとなく払い続けている光回線料金は、実は他社に乗り換えるだけで下がることがある。'
  ...
  nhk: {
    ...
    detail: 'テレビを持たない、またはチューナー非搭載のディスプレイ（ゲーム機・ネット動画専用機器）に'
           + '切り替えることで、NHK受信契約そのものが不要になる場合がある。',
  ...
  carInsurance: {
    ...
    detail: '代理店を通して契約した自動車保険は、営業コストが上乗せされ割高になりがちだ。'
           + 'ダイレクト型（ネット型）の自動車保険に切り替えることで、'
           + '同等の補償内容のまま保険料を抑えられる場合がある。',
...
export const URBAN_CAR_QUEST_TEXT = {
  ...
  detail: '東京23区や大阪市内など、公共交通機関が発達したエリアでのマイカー保有は、'
        + '家計に大ダメージを与える過剰装備だ。カーシェアやレンタカー、タクシーの活用に'
        + '切り替えることで、駐車場代や保険料を含め年間数十万円のゴールド（手取り）を確保できる。'
        + '本当に車が必要か、維持費と利用頻度を天秤にかけよ。',
  difficulty: 'hard',
...
export const CARD_QUEST_TEXT = {
  A: {
    id:'cardPatternA',
    mainTitle: '【低効率装備の換装】高還元カードへ乗り換えよ！',
    subTitle: '基本還元率の低いカードから、高還元カードへの乗り換えを促す。',
    detail: '普段使いのメインカードが、還元率0.5%前後の標準的なカードのままかもしれない。'
      + '年間の決済額次第では、還元率1.0%以上の高還元カードに乗り換えるだけで、'
      + '同じ買い物でも受け取れるポイントが単純に倍増する。',
    completeLabel: '🎉 還元率の高いカードに乗り換えた！'
  },
  B: {
    id:'cardPatternB',
    mainTitle: '【呪いの装備の解除】休眠カードを解約せよ！',
    detail: '【クエスト発生】呪いの装備を外してHPの漏れを塞げ！\n'
      + 'あなたの装備袋から、不穏な気配がする。現在保有している対象カードは、'
      + '十分な活躍をしていないにもかかわらず、毎年『年会費』というスリップダメージを'
      + 'あなたのHP（手取り）に与え続けている。なんとなく持っているだけの「呪いの装備」は、'
      + '思い切って手放すのが冒険の鉄則だ。今すぐカード会社のマイページや窓口に向かい、'
      + '装備を解呪（解約・ダウングレード）して、奪われていた手取りを取り戻せ！',
    completeLabel: '🎉 休眠カードを解約した！'
  },
  C: {
    id:'cardPatternC',
    mainTitle: '【100万円未達の罠】決済を集約し、呪縛を断て！',
    subTitle: '100万円決済に届いていないため、年会費が発生し還元率も0.5%に留まっている状態を警告。',
    detail: '「年間100万円決済で年会費無料・還元率アップ」という強力な特典を持つカードを保有しているが、'
      + '現在の推定決済額では100万円のラインに届いていない。届かない場合は年会費という'
      + 'コストだけが残ってしまう。決済を集約するか、届きそうにない場合は保有の見直しを検討せよ。',
    completeLabel: '🎉 カードの使い方を見直した！'
  },
  D: {
    id:'cardPatternD',
    mainTitle: '【コスト割れ特化装備】特化カードの契約を見直せ！',
    subTitle: '無料宿泊特典などのメリットを享受できる決済ラインに届いておらず、年会費が隠れ負債になっている状態を警告。',
    detail: '無料宿泊特典など、一定の決済額に到達すると強力な特典が得られる特化カードを保有しているが、'
      + '現在の推定決済額ではその損益分岐点に届いていない。年会費だけが負担になっている'
      + '可能性があるため、決済の集約や保有の見直しを検討せよ。',
    completeLabel: '🎉 カードの使い方を見直した！'
  }
};
...
export const LEGENDARY_HERO = {
  mainTitle: '【見直す余地なし】そなたは既に伝説の勇者である',
  subTitle: '魔道障壁（固定費のムダ）は一切見当たらない。そなたの家計は、すでに完璧な結界で守られているのだ！'
};
